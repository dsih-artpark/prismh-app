      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('executive.asha-workers.update', $user->id)}}" enctype='multipart/form-data'>
                  @csrf @method('put')
                <div class="row">
                ...
                <div class="btn-showcase text-end">
                  ...
                  <a href="{{ route('executive.asha-workers.index') }}" class="btn btn-light">Cancel</a>
                </div>
              </form>
            </div>
          </div>
