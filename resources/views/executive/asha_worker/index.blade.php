                ...
                <table class="display" id="table" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a href="{{route('executive.asha-workers.edit' , $worker->id)}}" class="btn btn-outline-primary-2x"><i class="icon-pencil-alt"></i></a>
                      </td>
                    </tr>
                    @php $i++; @endphp
                    @endforeach
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header pb-0">
              <h5>Asha Workers Not Approved</h5>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="display" id="table2" style="width:100%">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Name</th>
...
@section('script')
  ...
  <script>
    ...
    function changeStatus(id){
      $.ajax({
        method: "PUT",
        url: "{{ route('executive.asha-workers.index') }}"+"/"+id,
