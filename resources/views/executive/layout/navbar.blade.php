    ...
    <div class="page-header">
      <div class="header-wrapper row m-0"> 
        ...
        <div class="left-side-header ms-5 pt-3 col ps-0 d-none d-md-block">
          <h4>@if(Auth::user()->roles == 3) ZHO @else MOH @endif Login</h4>
        </div>
          ...
          <ul class="nav-menus">
            ...
            <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
              ...
              <ul class="profile-dropdown onhover-show-div">
                ...
                <li><a href="{{ route('executive.profile') }}"><i data-feather="user"></i><span>Edit Profile </span></a></li>
                <li><a href="{{ route('executive.logout') }}"><i data-feather="log-in"> </i><span>Log Out</span></a></li>
              </ul>
            </li>
          </ul>
        </div>
