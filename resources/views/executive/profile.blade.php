  ...
  <div class="container-fluid">
    <div class="edit-profile">
      <div class="row">
        ...
        <!-- -- -->
        <div class="col-xl-8">
          <form class="card " method="post" action="{{route('executive.profile')}}" enctype='multipart/form-data'>
            @csrf
            <div class="card-header pb-0">
              ...
              <div class="row">
                <div class="col-sm-6 col-md-3">
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="username" value="{{$user->username}}" placeholder="Name">
                  </div>
                </div>
