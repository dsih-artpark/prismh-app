...
<html lang="en">
  ...
  <body class="theme-light" data-highlight="grass">
    ...
    @include('spray_team.layout.right_sidebar')
    <div id="page">
      <div class="header header-fixed header-auto-show header-logo-app">
          <a href="{{route('spray_team.dashboard')}}" class="header-title">{{ __('messages.Pojecttitle') }}</a>
      </div>
      <div class="page-content" style="padding-bottom:0px;">
        @yield('content')
      </div>
      @include('spray_team.layout.footer')
    </div>
    @include('spray_team.layout.footerbar')
