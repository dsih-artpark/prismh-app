      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.zone.update', $zone->id)}}">
                @csrf @method('put')
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="validationCustom01">Name</label>
                    <input class="form-control" id="validationCustom01" type="text" name="title" placeholder="Enter Zone Name" value="{{$zone->title}}" required>
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="latitude">Latitude</label>
                    <input class="form-control" id="latitude" type="number" name="latitude" placeholder="Enter Zone Latitude" value="{{$zone->latitude}}" required>
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="longitude">Longitude</label>
                    <input class="form-control" id="longitude" type="number" name="longitude" placeholder="Enter Zone Longitude" value="{{$zone->longitude}}" required>
                  </div>    
                </div>
