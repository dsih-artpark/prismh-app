      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-sm-12">
          <div class="login-card" style="background-color:white;">
            <form class="theme-form login-form shadow" style="background-color: border:1px solid black;" action="{{ route('admin.login') }}?type=otp_login" method="post">
            {!! csrf_field() !!}
              <h4>Login</h4>
              <h6>Welcome back! Log in to your account.</h6>
              <div class="row">
                  <div class="col-lg-6 text-center" style="margin:auto;position:relative;">
              ...
              <h5 class="text-start mb-3 text-dark mt-5 mb-2 fs-5">Admin login</h5>
              ...
              <div class="form-group d-flex justify-content-between">
                <a href="{{route('admin.login')}}" class="text-primary">Login via Password</a>
