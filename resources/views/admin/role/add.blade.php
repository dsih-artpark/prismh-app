      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.role.store')}}">
                @csrf
                <div class="col-sm-12">
                  <div class="mb-3">
                    <label for="validationCustom01">Name</label>
                    <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Role Title" required value="{{old('name')}}">
                  </div>
                  <div class="mb-3">
                    <div class="media">
