      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.ward.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                
                
                <div class="mb-3">
                          <label class="form-label" for="validationCustom04">Division</label>
                  ...
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Ward name" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom01">Number</label>
                  <input class="form-control" id="validationCustom01" type="number" name="number" placeholder="Add Ward number" required="">
                </div>
