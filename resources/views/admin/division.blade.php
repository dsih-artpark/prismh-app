      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.division.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Division Title" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom01">Latitude</label>
                  <input class="form-control" id="validationCustom01" type="text" name="latitude" placeholder="Add Latitude" required="">
                </div>
                <div class="mb-3">
                  <label for="validationCustom01">Longitude</label>
                  <input class="form-control" id="validationCustom01" type="text" name="longitude" placeholder="Add Longitude" required="">
                </div>
                <div class="mb-3">
                  <div class="media">
