      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.zone.update', ["id"=>$zone->id])}}" enctype='multipart/form-data'>
                @csrf
                @method('PUT')
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Name</label>
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Zone Title" value="{{$zone->title}}" required>
                </div>
                <div class="mb-3">
                  <label for="validationCustom01">Latitude</label>
                  <input class="form-control" id="validationCustom01" type="text" name="latitude" placeholder="Add Latitude" value="{{$zone->latitude}}" required>
                </div>
                <div class="mb-3">
                  <label for="validationCustom01">Longitude</label>
                  <input class="form-control" id="validationCustom01" type="text" name="longitude" placeholder="Add Longitude" value="{{$zone->longitude}}" required>
                </div>
