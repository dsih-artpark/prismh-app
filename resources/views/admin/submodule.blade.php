      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Sub Modules</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h5>Add Sub Modules</h5>
          </div>
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.submodule.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Title</label>
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Sub Modules Title" required="">
                </div>
