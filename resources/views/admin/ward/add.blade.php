      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.ward.store')}}">
                @csrf
                <div class="col-sm-12">
                  <div class="mb-3">
                    <label for="validationCustom01">Ward Name</label>
                    <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Enter Ward Name" required value="{{old('name')}}">
                  </div>
                  <div class="mb-3">
                    <label for="ward_number">Ward Number</label>
                    <input class="form-control" id="ward_number" type="number" name="number" placeholder="Enter Ward Number"  value="{{old('number')}}">
                  </div>
                  <div class="mb-3">
