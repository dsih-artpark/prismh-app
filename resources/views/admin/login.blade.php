      ...
      <div class="row">
        ...
        <div class="col-lg-12 col-sm-12">
          <div class="login-card" style="background-color:white;">
            <form class="theme-form login-form shadow" style="background-color: border:1px solid black;" action="{{ route('admin.login') }}" method="post">
            {!! csrf_field() !!}
              <h4>Login</h4>
              ...
              <div class="form-group d-flex justify-content-between">
                <a href="{{route('admin.login')}}?type=otp_login" class="text-primary">Login via OTP</a>
