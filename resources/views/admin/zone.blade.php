      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body add-post">
            <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.zone.store')}}" enctype='multipart/form-data'>
                @csrf
              <div class="col-sm-12">
                <div class="mb-3">
                  <label for="validationCustom01">Name</label>
                  <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Add Zone Title" required="">
                </div>
                <div class="mb-3">
