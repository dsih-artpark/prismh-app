      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.asha-workers.store')}}" enctype='multipart/form-data'>
                  @csrf
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label class="form-label" for="role">Role</label>
                    <select class="form-control " id="ward" name="roles" required readonly>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="phone" minlength="10" maxlength="10" oninput="onlyNumber(this)" type="number" name="phone" placeholder="Add Phone number" required>
                ...
                <div class="btn-showcase text-end">
                  ...
                  <a href="{{ route('admin.asha-workers.index') }}" class="btn btn-light">Cancel</a>
                </div>
              </form>
            </div>
          </div>
