      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="row needs-validation " novalidate="" method="post" action="{{route('admin.division.update', $division->id)}}">
                @csrf @method('put')
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="validationCustom01">Division Name</label>
                    <input class="form-control" id="validationCustom01" type="text" name="name" placeholder="Enter Division Name" value="{{$division->name}}" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <select name="zone_id" class="form-control" required>
                      ...
                      @foreach($zones as $zone)
                        <option {{$division->zone_id == $zone->id ? 'selected' : ''}} value="{{$zone->id}}">{{$zone->title}}</option>
                      @endforeach
                    </select>
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    ...
                    <input class="form-control" id="latitude" type="text" name="latitude" placeholder="Enter Division Latitude" value="{{$division->latitude}}" required>
                  </div>    
                </div>
                <div class="col-sm-6">
                  <div class="mb-3">
                    <label for="longitude">Longitude</label>
                    <input class="form-control" id="longitude" type="text" name="longitude" placeholder="Enter Division Longitude" value="{{$division->longitude}}" required>
                  </div>    
                </div>
