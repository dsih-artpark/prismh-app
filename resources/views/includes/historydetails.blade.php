...
<span class="">{!! date('h:i a', strtotime($datadetails->created_at)) !!}</span><br><br>
<button onclick="getDirection({{explode(',',$datadetails->latit)[0]}}, {{explode(',',$datadetails->latit)[1]}})" class="btn btn-success btn-sm">
