...
<div class="card card-style">
    ...
    <div class="content mt-2 mb-0">
        ...
        <div class="d-flex">
            <div class="w-50 font-900 pb-2 color-highlight opacity-60 pb-3 text-start"><a href="{{ route('register') }}" class="p-2 bg-highlight rounded-sm">{{ __('messages.reghead') }}</a></div>
