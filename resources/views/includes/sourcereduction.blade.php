...
<div class="page-title page-title-small">
    <h2><a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>Source Reduction</h2>
...
@endif
   ...
   <div class="card card-style" style="margin-bottom: 80px!important;">
            <div class="content mb-0" >
                ...
                <form method="post" action="{{route('login.source-reduction.store', ["id"=>$id])}}" enctype='multipart/form-data'>
            @csrf
            @method('PUT')
<div class="row mb-4">
...
<span class="color-highlight">Source Reduction</span>
<div class="fac fac-radio "><span></span>
<input id="box1-fac-radio-q11" class="breed" type="radio" name="phone" value="Done" >
<label for="box1-fac-radio-q11">Done</label>
</div>
<div class="fac fac-radio "><span></span>
<input id="box2-fac-radio-q12" class="breed" type="radio" name="phone" value="Not Done" checked>
<label for="box2-fac-radio-q12">Not Done</label>
</div>
