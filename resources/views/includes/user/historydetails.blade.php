...
<div class="page-title page-title-small">
    <h2><a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>History Details</h2>
...
<div data-card-height="400" class="card preload-img mb-3" style="height: 400px;"  data-src="{{asset('uploads/pick')}}/<?=$datadetails->image_data;?>">
...
@if($datadetails->q1)
<span class="">Does breeding spot exist ? {{$datadetails->q1}}</span>
@endif
