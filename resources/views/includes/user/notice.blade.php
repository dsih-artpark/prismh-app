...
<div class="page-title page-title-small">
    <h2><a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>Notice</h2>
...
@endif
 ...
 <div class="row mb-0">
    ...
    @if($cnt%2==0)
    @php
    $dumpdetails =  DB::table('cdverify')->where('did', $res->id)->where('status', '2')->first();
    @endphp
...
<!--<div class="text-center"><p class="btn bg-highlight ">Verified</p></div>-->
