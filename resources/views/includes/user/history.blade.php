...
<div class="page-title page-title-small">
    <h2><a href="#" data-back-button><i class="fa fa-arrow-left"></i></a>History</h2>
    ...
    @if($cnt%2==0)
     ...
     <div class="col-6 pe-0">
                <div class="card card-style me-2">
                    <a  data-card-height="150" class="card preload-img mb-3" data-src="{{url('public/uploads/pick') }}/{{$res->image_data}}"  href="{{route('user.history.detail',['id' => $res->id])}}">
                        <div class="card-bottom mb-2">
                            
                        </div>
                        <div class="card-overlay  rounded-0"></div>
                    </a>
                    <div class="content mt-0 text-center">
<span class="color-black"><b>{{$res->uid}}</b></span><br>
<!--<span class="color-black"></span><br>-->
...
@if($res->q1 == "Yes")
@php
    $dumpdetails =  DB::table('dump')->where('pid', $res->id)->first();
    @endphp
    @if(empty($dumpdetails))
<div class="text-center"><a href="{{route('user.dump.id', ['id' => $res->id])}}" class="btn bg-highlight ">Spray</a></div>
@endif
@endif
