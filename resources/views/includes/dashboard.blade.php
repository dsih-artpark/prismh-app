                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6 col-sm-6 col-6 font-20 text-center px-0">
                      @php
                        ...
                        $res =  DB::table('pick')->where('cust_id', $upid)->where('created_at','LIke', \Carbon\Carbon::today()->format('Y-m-d').'%')->where('status', 1)->count();
                        
                        
                        $rest =  DB::table('pick')->where('cust_id', $upid)->where('status', 1)->count();
