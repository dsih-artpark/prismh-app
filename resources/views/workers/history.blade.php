...
@section('content')
  <div class="page-content" style="padding-bottom: 0px; transform: translateX(0px);">
    @include('workers.layout.header', ['title' => __('messages.History'), 'back' => false])
    <div class="row mb-0">
      ...
      <div class="col-6 mb-md-2">
        <div class="card card-style mb-3 {{$key % 2 != 0 ? 'ms-0 ps-0' : 'me-0 pe-0'}}">
          ...
          <a  data-card-height="150" class="card preload-img mb-3" data-src="{{url('public/uploads/pick') }}/{{$img[0]}}"  href="{{route('field-executive.history_details', $survey->id)}}"></a>
