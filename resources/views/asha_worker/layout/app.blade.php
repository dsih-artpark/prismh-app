...
<html lang="en">
  ...
  <body class="theme-light" data-highlight="grass">
    ...
    @include('asha_worker.layout.right_sidebar')
    <div id="page">
      <div class="header header-fixed header-auto-show header-logo-app">
          <a href="{{route('asha_worker.dashboard')}}" class="header-title">{{ __('messages.Pojecttitle') }}</a>
      </div>
      <div class="page-content" style="padding-bottom:0px;">
        @yield('content')
        @include('asha_worker.layout.footer')
      </div>
      @include('asha_worker.layout.footerbar')
    </div>
