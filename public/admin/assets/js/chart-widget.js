...
var optionscolumnchart = {
        series: [{
          name: 'Picked',
          data: [44, 87, 127, 56, 61,78,54,156]
        }, {
          name: 'Dumped',
          data: [23, 74, 99, 21, 55,47,22,101]
        }],
    ...
    xaxis: {
        //categories: ['Bommanahali', 'Dasarahali', 'Mahadevpura', 'East', 'West', 'North', 'South', 'Jaynagar'],
        
        //categories : zones,
        
        categories: ['Bommanahalli', 'Dasarahalli', 'East', 'Mahadevapura', 'R.R.Nagar', 'South', 'West', 'Yelahanka'],
    },
    yaxis: {
        title: {
            text: 'C&D Waste'
    ...
    fill: {
        colors:[zetaAdminConfig.success, zetaAdminConfig.danger, '#51bb25'],
        type: 'gradient',
        gradient: {
            shade: 'light',
            type: 'vertical',
