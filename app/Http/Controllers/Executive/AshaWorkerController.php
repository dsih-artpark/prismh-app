...
class AshaWorkerController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('executive.asha_worker.index', compact('asha_workers'));
    }
    ...
    public function edit($id)
    {
      ...
      return view('executive.asha_worker.edit', compact('user','roles','wards'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      try{
        ...
        return redirect()->route('executive.asha-workers.index')->with ('succes', 'User updated successfully');
      } catch(\Throwable $e){
