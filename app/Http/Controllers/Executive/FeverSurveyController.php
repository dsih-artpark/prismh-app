...
class FeverSurveyController extends Controller
{
    ...
    {
      return view('executive.fever_survey.index');
    }
    ...
    public function create(Request $request)
    {
      ...
      foreach($records as $key => $record){
        ...
        $action = '<a href="'.route('executive.fever-survey.show' , $record->id).'"  class="btn btn-outline-primary-2x"><i class="fa fa-eercast" aria-hidden="true"></i></a>';
    ...
    public function show($id)
    {
      ...
      return view('executive.fever_survey.show', compact('data'));
    }
}
