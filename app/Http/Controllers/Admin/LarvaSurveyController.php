...
class LarvaSurveyController extends Controller
{
    ...
    {
      return view('admin.larva_survey.index');
    }
    ...
    public function create(Request $request)
    {
      ...
      foreach($records as $key => $record){
        ...
        $action = '<a href="'.route('admin.larva-survey.show' ,$record->id).'" class="btn btn-outline-primary-2x"><i class="fa fa-eercast" aria-hidden="true"></i></a>';
    ...
    public function show($id)
    {
      ...
      return view('admin.larva_survey.show', compact('data'));
    }
}
